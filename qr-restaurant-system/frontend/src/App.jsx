...
import { TableSelectDemoPage } from './customer/pages/TableSelectDemoPage';
          ...
          >
            <div>
              ...
              <p className="text-xs text-slate-400 mt-1 leading-relaxed">
                Select an active table from database to simulate scanning a real table QR code, browse dishes, and order live.
              </p>
            </div>
            <div className="mt-6 flex items-center text-xs font-semibold text-brand-400 group-hover:translate-x-1 transition-transform">
              Select Table & Order <ArrowRight size={14} className="ml-1" />
            </div>
          </Link>
...
export default function App() {
  return (
    <Routes>
      ...
      <Route path="/tables-demo" element={<TableSelectDemoPage />} />
