...
export const AdminSidebar = ({ onClose }) => {
  ...
  return (
    <aside className="h-full bg-[#121110] text-stone-200 p-4 flex flex-col justify-between border-r border-stone-800 shadow-2xl">
      <div>
        ...
        <div className="mt-1 mb-6 px-3 py-2.5 rounded-2xl bg-stone-900/90 border border-stone-800/80 flex items-center justify-between cursor-pointer hover:border-stone-700 transition-colors">
      ...
      {/* Bottom User Profile Card with Sign Out */}
